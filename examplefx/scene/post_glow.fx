/*********************************************************************NVMH3****
File:  $Id: //sw/devtools/FXComposer1.0/SDK/MEDIA/HLSL/Glow.fx#8 $
...
{   
    float4 OutCol = tex2D(SceneSampler, IN.TexCoord0) * (WT9_1/WT9_NORMALIZE);
...
{   
	float4 tex = tex2D(SceneSampler, float2(IN.TexCoord0.x, IN.TexCoord0.y));
	return tex;
}  
